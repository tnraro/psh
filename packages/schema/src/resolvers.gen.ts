...
export type DeviceTypeResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['DeviceType'] = ResolversParentTypes['DeviceType']> = ResolversObject<{
...
export type DeviceResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Device'] = ResolversParentTypes['Device']> = ResolversObject<{
  ...
  type?: Resolver<Maybe<ResolversTypes['DeviceType']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type QueryResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  deviceTypes?: Resolver<Maybe<Array<Maybe<ResolversTypes['DeviceType']>>>, ParentType, ContextType>;
  fetchDeviceStatus?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<QueryFetchDeviceStatusArgs, 'device'>>;
}>;
...
export type MutationResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  newDevice?: Resolver<Maybe<ResolversTypes['Device']>, ParentType, ContextType, RequireFields<MutationNewDeviceArgs, 'device'>>;
  deleteDevice?: Resolver<Maybe<ResolversTypes['Device']>, ParentType, ContextType, RequireFields<MutationDeleteDeviceArgs, 'id'>>;
  tnid?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  pushDeviceStatus?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationPushDeviceStatusArgs, 'device'>>;
}>;
