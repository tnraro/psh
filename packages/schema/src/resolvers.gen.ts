...
export type TermsResolvers<
    ContextType = IContext,
    ParentType extends ResolversParentTypes["Terms"] = ResolversParentTypes["Terms"]
> = ResolversObject<{
    agelimit?: Resolver<
        Maybe<ResolversTypes["Boolean"]>,
        ParentType,
...
> = ResolversObject<{
    newUser?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationNewUserArgs, "user">
    >;
    signInUser?: Resolver<
        Maybe<ResolversTypes["Session"]>,
        ParentType,
        ContextType,
        RequireFields<MutationSignInUserArgs, "user">
    >;
    newHome?: Resolver<
        Maybe<ResolversTypes["Home"]>,
        ParentType,
        ContextType,
        RequireFields<MutationNewHomeArgs, "name">
    >;
    joinHome?: Resolver<
        Maybe<ResolversTypes["Home"]>,
        ParentType,
